    ...
    <>
      ...
      >
        <div className="iconSet1 relative">
          <HtmlCube customStyle={{ position: "absolute", top: "0.5em", right: "5rem" }} />
          <BootstrapCube customStyle={{ position: "absolute", top: "10rem", right: "0" }} />
          <CssCube customStyle={{ position: "absolute", left: "3rem" }} />
          <WebpackCube
            customStyle={{
              position: "absolute",
              bottom: "5rem",
          ...
          />
          <GitCube customStyle={{ position: "absolute", bottom: "0", right: "0" }} />
        </div>
        ...
        <div className="iconSet2 relative">
          ...
          />
          <ReactCube customStyle={{ position: "absolute", top: "18rem", left: "3rem" }} />
          <ReduxCube
            customStyle={{
              position: "absolute",
              bottom: "9rem",
          ...
          />
          <JavascriptCube customStyle={{ position: "absolute", top: "2rem", left: "6rem" }} />
          <JqueryCube customStyle={{ position: "absolute", top: "2rem", right: "7rem" }} />
          <SassCube customStyle={{ position: "absolute", top: "10rem", right: "2rem" }} />
          <MongodbCube customStyle={{ position: "absolute", bottom: "0", left: "5rem" }} />
        </div>
      </section>
    </>
  );
